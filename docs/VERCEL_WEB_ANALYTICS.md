...
### For React (Create React App / Vite + React)
...
Add the following code to your main app file (`src/App.jsx` or `src/App.tsx`):
...
**Available in version `@vercel/analytics@1.4.0` and later.**
